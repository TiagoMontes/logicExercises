...
function consecString(arrayString, consecutive) {
    ...
    // enquanto consecutive for maior que zero (eliminando possibilidades negativas), e i for menor ou igual ao tamanho da array - N cosnecutivos (assim, no caso de você ter N consecutivos maior que a array, ele irá encerrar o looping pois não há valores para calcular a soma dos consecutivos)
